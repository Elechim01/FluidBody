...
struct Home: View {
    ...
    @State var promotions: [Promotion] = [
        .init(name: "TripAdvisor", title: "Your saved search to Vienna", subTitle:
                placeholderText, logo: "Logo1"),
        .init(name: "Figma", title: "Flama mentions are here!", subTitle: placeholderText, logo: "Logo2"),
        .init(name:"Product Hunt Daily", title: "Must-have Chrome Extensions", subTitle:
                placeholderText, logo: "Logo3"),
        .init(name:"invision", title:"First interview with ",subTitle: placeholderText, logo: "Log 4"),
        .init(name: "Pinterest", title: "You've got 18 new Ideas waiting for vou!",
              subTitle: placeholderText, logo: "Logo5"),
    ]
...
//MARK: Promoton Card View With Gooey Cell Animation
